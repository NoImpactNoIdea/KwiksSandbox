...
class ChatMainCell : UICollectionViewCell {
    ...
    let messageLabel : UILabel = {
        ...
        thl.text = "Hello everyone here in the field"
    ...
    func addViews() {
        ...
        self.chatBubble.bottomAnchor.constraint(equalTo: self.profilePhoto.bottomAnchor, constant: 0).isActive = true
    ...
    override func layoutSubviews() {
        ...
        DispatchQueue.main.async {
            ...
            if frameHeight < 45.0 {
                ...
                self.chatBubble.layer.cornerRadius = 16
            }
        }
    }
